...
main (int argc, char *argv[])
{
  ...
  phy.SetChannel (channel.Create ()); //  all the PHY layer objects created by the YansWifiPhyHelper share the same underlying channel
  ...
  WifiMacHelper mac;
  Ssid ssid = Ssid ("ns-3-ssid"); //  creates an 802.11 service set identifier (SSID) object
  ...
  apDevices = wifi.Install (phy, mac, wifiApNode); // single AP which shares the same set of PHY-level Attributes (and channel) as the station
