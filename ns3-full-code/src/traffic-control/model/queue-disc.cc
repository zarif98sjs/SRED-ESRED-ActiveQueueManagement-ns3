...
QueueDisc::Stats::Print (std::ostream &os) const
{
  ...
  while (itp != nMarkedPackets.end () &&
    ...
    os << "Drop Ratio: "
                  << nTotalDroppedPackets << " / "
                  << nTotalReceivedPackets << " = " << (nTotalDroppedPackets*100.0)/nTotalReceivedPackets <<"%";
    os << std::endl << "Delivery Ratio: "
                  << nTotalReceivedPackets - nTotalDroppedPackets << " / "
                  << nTotalReceivedPackets << " = " << ((nTotalReceivedPackets - nTotalDroppedPackets)*100.0)/nTotalReceivedPackets <<"%";
