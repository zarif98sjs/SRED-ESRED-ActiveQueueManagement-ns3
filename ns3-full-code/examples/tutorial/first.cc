...
main (int argc, char *argv[])
{
  ...
  LogComponentEnable ("UdpEchoClientApplication", LOG_LEVEL_INFO); //  enable logging components that is built into the Echo Client
  ...
  echoClient.SetAttribute ("MaxPackets", UintegerValue (2)); // maximum number of packets we allow it to send during the simulation
