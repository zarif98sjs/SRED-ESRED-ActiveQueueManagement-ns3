...
int main (int argc, char *argv[])
{
  ...
  // VARIABLE PARAMETERS
  uint32_t nWifi = 3; // 3 , 6, 10 , 13 , 18 
  std::string appDataRate = "10Mbps"; // 3000/50 -> 60, 6000 -> 120, 10000/50 -> 200, 13000/50 -> 260, 18000/50 -> 360
  int32_t num_flow = nWifi; // 10 , 20 , 30 , 40 , 50
